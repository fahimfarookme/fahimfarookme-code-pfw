...
status=published
subtitle=A story about the mysteries of Netflix Eureka self-preservation
description=Understanding Eureka self-preservation - what it is, why it exists, how it's calculated, and whether you should turn it off.
~~~~~~
...
<figure>
<img src="/images/blog/eureka-self-preservation/eureka-before-network-partition.png" alt="The healthy system - before encountering any network partitions">
<figcaption>The healthy system - before encountering any network partitions</figcaption>
</figure>
...
<figure>
<img src="/images/blog/eureka-self-preservation/eureka-during-network-partition.png" alt="The system during a network partition - Eureka servers enter the self-preservation mode">
<figcaption>The system during a network partition - Eureka servers enter the self-preservation mode</figcaption>
</figure>
...
<figure>
<img src="/images/blog/eureka-self-preservation/eureka-during-self-preservation.png" alt="The system during the self-preservation mode - Eureka servers stop expiring any microservice instances">
<figcaption>The system during the self-preservation mode - Eureka servers stop expiring any microservice instances</figcaption>
</figure>
...
Since N is a variable, 2 * N * 0.85 is calculated in every 15 minutes by default (or in every `renewal-threshold-update-interval-ms`).
