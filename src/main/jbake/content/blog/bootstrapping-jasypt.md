...
date=2020-06-01
type=post
tags=spring-cloud, security, jasypt
status=published
subtitle=Making Jasypt cloud-ready
...
Spring cloud defines a [*Bootstrap phase*](http://cloud.spring.io/spring-cloud-static/spring-cloud.html#_the_bootstrap_application_context) wherein it creates a context from configurations in the `bootstrap.properties` (or .yml) file. The `bootstrap.properties` file is usually packaged in microservices (i.e. config clients) and having following 2 configurations.
...
<figure>
<img src="/images/blog/bootstrapping-jasypt/spring-cloud-bootstrap-phase.png" alt="Spring Cloud bootstrap phase" style="width:70%">
<figcaption>Spring Cloud bootstrap phase</figcaption>
</figure>
